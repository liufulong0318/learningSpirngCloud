...
public class TestService {
    public static String imgBinarization(String srcImgPath) throws IOException {
        ...
        int endIndex = srcImgPath.lastIndexOf("/");
        String newFile = srcImgPath.substring(0,endIndex+1)+"new_"+srcImgPath.substring(endIndex+1,srcImgPath.length());
